...
<body>
    ...
    <main class="mainLogin">
        ...
        <section class="registro" id="createAccount">
            <form action="/BDD/reguistro.php"class="form-register" method="post" id="createAccount">
                ...
                <p class="form__text"><a href="/templates/login.php"  id="linkLogin">Acceder</a></p>
            </form>
        </section>    
    </main>
